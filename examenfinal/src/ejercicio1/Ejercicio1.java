...
// Implementa la lógica del ejercicio 1 aquí
    ...
    public static void main(String[] args) {
        calcularFibonacci(20);// cambie el 10 ´por cualquiera que le apetaca, profe no toque mas que se cae apedasos esto depues de 50 la maquina lo le da 
    }
    public static void calcularFibonacci(int n) {
        System.out.println("El " + n + "-ésimo numero de la secuencia de Fibonacci es: " + fibonacci(n));
    }
/**
 * hace el calculo 
 * @param n
